...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.jitter2 = QtWidgets.QCheckBox(self.formLayoutWidget_4)
        self.jitter2.setObjectName("jitter2")
        self.jitter2.setText("jitter2")
        self.jitter2.setToolTip("Improved jitter analysis")
        self.formLayout_4.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.jitter2)
        ...
        def setSchemes():
            ...
            if self.jitter2.isChecked():
                gSchemes.append("jitter2")
    ...
    for tasks in tasksets:
        if ischeme == "SCEDF":
            ...
            if FixedPriority.SuspJit(tasks) == False:
                counter += 1
        elif ischeme == "jitter2":
            if Jitter.sched_test(tasks) == False:
                counter += 1
